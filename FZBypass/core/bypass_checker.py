...
async def direct_link_checker(link, onlylink=False):
    ...
    if not domain:
        raise DDLException("Invalid URL Format Provided!")
    ...
    # DDL Links
        ...
        blink = await transcript(link, "https://go.adsfly.in/", "https://letest25.co/", 3)
        ...
        blink = await transcript(link, "https://go.ronylink.com/", "https://livejankari.com/", 3)
        ...
        blink = await transcript(link, "https://news.sagenews.in/", "https://movies.djnonstopmusic.in/", 5)
    elif bool(match(r"https?:\/\/(xpshort|push.bdnewsx|techymozo)\.\S+", link)):
        blink = await transcript(link, "https://xpshort.com/", "https://www.comptegratuite.com/", 4.9)
        ...
        blink = await transcript(link, "https://techy.veganab.co/", "https://camdigest.com/", 5)
    elif bool(match(r"https?:\/\/.+\.tnlink\.\S+", link)):
        blink = await transcript(link, "https://news.sagenews.in/", "https://knowstuff.in/", 5)
        ...
        blink = await transcript(link, "https://mdisk.pro", "https://www.meclipstudy.in/", 5)
        ...
        blink = await transcript(link, "https://mdiskshortner.link", "https://yosite.net/", 0)
    elif bool(match(r"https?://(?:\w+\.)?rocklinks\.\S+", link)):
        blink = await transcript(link, "https://land.povathemes.com/", "https://blog.disheye.com/", 4.9)
        ...
        blink = await transcript(link, "https://appsinsta.com/blog", "https://pracagov.com/", 3)
        ...
        blink = await transcript(link, "https://vplink.in", "https://insurance.findgptprompts.com/", 5)
        ...
        blink = await transcript(link, "https://linkshortx.in/", "https://nanotech.org.in/", 4.9)
    elif bool(match(r"https?:\/\/.+\.shorito\.\S+", link)):
        blink = await transcript(link, "https://go.shorito.com/", "https://healthgo.gorating.in/", 8)
    elif bool(match(r"https?:\/\/pdisk\.\S+", link)):
        blink = await transcript(link, "https://last.moneycase.link/", "https://www.webzeni.com/", 4.9)
    elif bool(match(r"https?:\/\/ziplinker\.\S+", link)):
        blink = await transcript(link, "https://ziplinker.net", "https://fintech.techweeky.com/", 1)
    ...
    # ADVANCED UNIVERSAL & GADGETSWEB & FALLBACK ROUTES
    else:
        try:
